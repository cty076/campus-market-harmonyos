...
const requiredText = [
  ...
  ['entry/src/main/ets/pages/Index.ets', 'hasLocatedPoint'],
  ...
  ['entry/src/main/ets/pages/DetailPage.ets', 'hasLocatedPoint'],
  ['entry/src/main/ets/pages/DetailPage.ets', '当前位置不在已划定校园区域内'],
  ...
  ['entry/src/main/ets/view/GoodsListComponent.ets', '@Prop hasLocatedPoint'],
  ...
  ['entry/src/main/ets/view/GoodsCardComponent.ets', '@Prop hasLocatedPoint'],
  ...
  ['entry/src/main/ets/view/RegionRecommendPanel.ets', '@Prop hasLocatedPoint'],
  ...
  ['entry/src/main/ets/view/RegionRecommendPanel.ets', '区域外'],
  ['entry/src/main/ets/view/RegionRecommendPanel.ets', '不在已划定校园区域内'],
